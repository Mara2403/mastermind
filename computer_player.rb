...
# Creates version of the game for a computer as the code breaker. Computer uses only the feedback of exact good numbers
class ComputerPlayer
  ...
  def play_game
    ...
    12.times do |turn|
      ...
      puts "Turn #{turn + 1}. Computer guess: "
      show_code(random_guess)
      ...
      puts ingame_text('computer_lost')
      user_choice = play_again?
      choose_mode if user_choice == 'y'
      puts ingame_text('break') if user_choice == 'n'
    end
